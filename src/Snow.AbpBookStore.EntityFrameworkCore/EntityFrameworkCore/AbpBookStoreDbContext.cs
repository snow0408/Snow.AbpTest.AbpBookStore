...
public class AbpBookStoreDbContext :
    AbpDbContext<AbpBookStoreDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AbpBookStoreConsts.DbTablePrefix + "Books",
                AbpBookStoreConsts.DbSchema);
        ...
        {
            b.ToTable(AbpBookStoreConsts.DbTablePrefix + "Authors",
                AbpBookStoreConsts.DbSchema);
